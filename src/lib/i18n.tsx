...
const translations = {
  en: {
    ...
    'hero.bio':
      '5+ years shipping production software at scale — distributed architectures, live service platforms, critical data pipelines. First-author XR researcher (Polytechnique Montréal). Available for freelance contracts.',
    ...
    'about.bio1':
      "I've spent the last 5 years building systems that actually hold up under pressure — the kind that serve millions of users and can't go down on a Friday night. I like hard problems and I like shipping things.",
    'about.bio2':
      "On the side, I did a research master's at Polytechnique — studying how humans can control drone swarms through augmented reality. That paper got picked up by TechXplore, which was a nice surprise. I still think about the intersection of physical world and software a lot.",
    'about.bio3':
      "I write mostly Go, TypeScript and C#. I pick up new stacks fast — I've jumped into codebases and domains I didn't know and was productive within days. I care about clean code, but more about clear thinking. I work well autonomously, communicate early when something's off, and I genuinely enjoy collaborating with people who give a damn about what they build.",
    ...
    'pub.summary':
      'Designed and validated a hands-free AR interface on Microsoft HoloLens 1.0 and Magic Leap 1 enabling a single operator to control a UAV swarm in fire emergency scenarios. Comparative experiments against desktop controls. Published on arXiv, covered by TechXplore.',
    ...
    'contact.subtitle':
      "Senior fullstack engineer available for freelance contracts. Distributed systems, live service platforms, XR. Let's talk.",
  ...
  fr: {
    ...
    'hero.subtitle':
      'Fullstack · Systèmes Distribués · Plateformes Live Service',
    'hero.bio':
      '5+ ans à livrer du logiciel de production à grande échelle — architectures distribuées, plateformes live service, pipelines de données critiques. Chercheur XR premier auteur (Polytechnique Montréal). Disponible pour contrats freelance.',
    ...
    'about.bio1':
      "Ça fait 5 ans que je construis des systèmes qui tiennent vraiment la route — ceux qui servent des millions d'utilisateurs et qui n'ont pas le droit de tomber un vendredi soir. J'aime les problèmes complexes, et j'aime livrer.",
    'about.bio2':
      "En parallèle, j'ai fait un master recherche à Polytechnique — sur comment des humains peuvent contrôler des essaims de drones via la réalité augmentée. L'article a été repris par TechXplore, ce qui était une belle surprise. Je pense encore souvent à l'intersection monde physique et logiciel.",
    'about.bio3':
      "J'écris surtout du Go, TypeScript et C#. Je prends de nouvelles stacks en main rapidement — je suis rentré dans des codebases et des domaines que je ne connaissais pas et j'étais opérationnel en quelques jours. Je fais attention au code propre, mais plus encore à la clarté de pensée. Je travaille bien en autonomie, je communique tôt quand quelque chose cloche, et j'aime vraiment bosser avec des gens qui se soucient de ce qu'ils construisent.",
    'about.location': 'Montréal, QC, Canada',
    ...
    'pub.summary':
      "Conception et validation d'une interface RA mains-libres sur Microsoft HoloLens 1.0 et Magic Leap 1 permettant à un seul opérateur de piloter un essaim de drones lors d'urgences incendie. Expériences comparatives contre contrôles bureau. Publié sur arXiv, couvert par TechXplore.",
    ...
    'contact.subtitle':
      'Ingénieur fullstack senior disponible pour contrats freelance. Systèmes distribués, plateformes live service, XR. Parlons-en.',
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      /* Storage may be disabled; English remains the default. */
    }
  }, [])
