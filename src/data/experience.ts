...
export const experiences: Experience[] = [
  {
    ...
    highlights: {
      en: [
        'Lead engineering work on monetization tooling: technical direction, sprint coordination, mentoring and collaboration across teams.',
      ...
      fr: [
        'Leadership de l’ingénierie sur les outils de monétisation : direction technique, coordination des sprints, mentorat et collaboration entre équipes.',
