...
export const site = {
  en: {
    ...
    contactLabel: 'FREELANCE ENGINEERING',
    contactTitle: 'Let’s move your\nproject forward.',
    contactText:
      'An idea to develop, a technical roadblock or a team that needs support? I can help with a focused task or work alongside you throughout the project.',
    contactServicesLabel: 'Where I can help',
    contactServices: [
      ['Build an application', 'Web, mobile, business tools and APIs.'],
      ['Solve a technical problem', 'Architecture, data, integrations and production issues.'],
      ['Automate everyday work', 'AI agents, connected tools and team workflows.'],
    ],
    contactInvitation: 'Tell me what you’re working on — even if the brief isn’t ready yet.',
    emailCta: 'Let’s discuss your project',
  ...
  fr: {
    ...
    contactLabel: 'INGÉNIEUR INDÉPENDANT',
    contactTitle: 'Faisons avancer\nvotre projet.',
    contactText:
      'Une idée à développer, un blocage technique ou une équipe à renforcer ? Je peux intervenir sur un besoin précis ou vous accompagner tout au long du projet.',
    contactServicesLabel: 'Je peux vous aider à',
    contactServices: [
      ['Créer une application', 'Web, mobile, outils métier et API.'],
      ['Résoudre un problème technique', 'Architecture, données, intégrations et incidents de production.'],
      ['Automatiser le travail quotidien', 'Agents IA, outils connectés et processus d’équipe.'],
    ],
    contactInvitation: 'Parlez-moi de votre besoin, même sans cahier des charges.',
    emailCta: 'Discutons de votre projet',
    linkedinCta: 'Échangeons sur LinkedIn',
    cvTitle: 'Mon CV',
